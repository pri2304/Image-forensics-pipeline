...
print("RUNNING PAIR SWEEP")

all_pairs = list(
    combinations(feature_cols, 2)
)
...
print("\n")
print("=" * 80)
print("TOP 25 PAIRS BY ACCURACY")
print("=" * 80)
...
joblib.dump(
    ...
    "Models/forensic_gbt_pair_best.pkl"
)

results_df.to_csv(
    "pair_sweep_results.csv",
    index=False
)

print("\nSaved:")
print("Models/forensic_gbt_pair_best.pkl")
print("pair_sweep_results.csv")